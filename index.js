const record = [
    ...
    //Variable Holds Working Function, But Does Not Passs Test
//const value = record.find(superbowlWin).year;

const value = record.find(superbowlWin).year;

function superbowlWin(array) {
    //for (const array of "W") {
     if (array.result === "W") {
        return array
     }
    }
...
console.log(value)
  ...
  //GIVES ME YEAR 2015, BUT DOES NOT PASS TEST
// function superbowlWin(array) {
//     return array.result === "W";
// }
  

    //GIVES ME UNDEFINED, BUT DOES NOT PASS TEST
// function superbowlWin(array) {
//       array.result === "W";
//         return array.year
